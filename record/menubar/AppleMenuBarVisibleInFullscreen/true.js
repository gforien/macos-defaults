...
module.exports = {
  run: async (outputPath) => {
    console.log(
      '> Recording menu bar clock AppleMenuBarVisibleInFullscreen with param set to true',
    )
    ...
    const { stderr: setEnvError } = await exec(
      `defaults write NSGlobalDomain AppleMenuBarVisibleInFullscreen -bool true && killall SystemUIServer && sleep 10`,
    )
